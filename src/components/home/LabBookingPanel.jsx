        ...
        <div className="p-4 flex-1 flex flex-col justify-between gap-3 min-h-0">
          <div className="rounded-xl border border-amber-200/60 bg-gradient-to-r from-[#FFFBEB] to-white p-3.5 flex flex-col sm:flex-row sm:items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-[16px] font-bold text-navy leading-tight">No lab test booked</p>
    ...
    <section className="h-full min-h-0 bg-white rounded-2xl border border-border-gray shadow-sm overflow-hidden flex flex-col">
      ...
      >
        ...
        <div className="min-w-0 flex-1">
          <p className="text-[17px] font-bold text-navy truncate">{booking.test?.name || 'Lab test'}</p>
      ...
      <div className="px-4 flex flex-col gap-2.5 flex-1 min-h-0">
        ...
        <div className="rounded-xl bg-[#F8FAFC] border border-[#E6EBF1] px-3 py-2.5">
          ...
          {booking.test?.price != null ? (
            <p className="text-[14px] font-bold text-navy mt-1.5 pl-6">₹{booking.test.price}</p>
          ) : null}
        </div>
      </div>
