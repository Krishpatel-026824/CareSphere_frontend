...
export default function HealthRecordsList({
  ...
  return (
    <section className="rounded-2xl border border-[#E6EBF1] bg-white shadow-sm overflow-hidden">
      <div className="px-4 sm:px-5 pt-4 pb-4 border-b border-[#E6EBF1] bg-[#F8FAFC]">
