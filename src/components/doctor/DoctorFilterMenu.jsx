...
import { doctorFilterOptions } from '../../data/mocks/doctorFilters'

export default function DoctorFilterMenu({ open, listFilter, onSelect, onClose }) {
  if (!open) return null
  ...
  return (
    <>
      ...
      >
        {doctorFilterOptions.map((option) => {
